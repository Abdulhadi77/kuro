	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('voteplans/'.$voteplans->id)}}" class="dropdown-item" style="color:#343a40">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}}  ({{$voteplans->id}})
					</div>
...
{!! Form::open(['url'=>aurl('/voteplans/'.$voteplans->id),'method'=>'put','id'=>'voteplans','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('type',trans('admin.type'),['class'=>'control-label']) !!}
        {!! Form::text('type', $voteplans->type ,['class'=>'form-control','placeholder'=>trans('admin.type')]) !!}
    </div>
</div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('num_votes_cond', $voteplans->num_votes_cond ,['class'=>'form-control','placeholder'=>trans('admin.num_votes_cond')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('kuro_balance_cond',trans('admin.kuro_balance_cond'),['class'=>'control-label']) !!}
        {!! Form::text('kuro_balance_cond', $voteplans->kuro_balance_cond ,['class'=>'form-control','placeholder'=>trans('admin.kuro_balance_cond')]) !!}
    </div>
</div>
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('revenue',trans('admin.revenue'),['class'=>' control-label']) !!}
            {!! Form::text('revenue', $voteplans->revenue,['class'=>'form-control','placeholder'=>trans('admin.revenue')]) !!}
    </div>
</div>

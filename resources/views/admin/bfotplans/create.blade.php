	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('bfotplans') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/bfotplans'),'id'=>'bfotplans','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('num_of_refs_cond',trans('admin.num_of_refs_cond'),['class'=>' control-label']) !!}
            {!! Form::text('num_of_refs_cond',old('num_of_refs_cond'),['class'=>'form-control','placeholder'=>trans('admin.num_of_refs_cond')]) !!}
    </div>
</div>

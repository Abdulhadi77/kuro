	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('icos') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/icos'),'id'=>'icos','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('open_date',old('open_date'),['class'=>'form-control float-right date_time_picker','placeholder'=>trans('admin.open_date'),'readonly'=>'readonly']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->

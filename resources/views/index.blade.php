    ...
    <main id="main">
        ...
        <section id="portfolio" class="portfolio">
            ...
            <div class="container" data-aos="fade-up">
                ...
                @if($banners->count() == 1)
                        <div class="col-lg-1 col-md-6 portfolio-item filter-app justify-content-center">
                    ...
                    @foreach ($banners as $banner)
                                <div   class=" test col-lg-3 col-md-6 portfolio-item filter-app justify-content-center">

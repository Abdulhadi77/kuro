...
{{--    </div>--}}
          ...
          <div class="col-lg-3 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="#">WhitePaper</a></li>
                  <li><i class="bi bi-chevron-right"></i> <a href="{{url('/vote')}}">Vote To Earn</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{url('/Beteam')}}">Be From Our Team</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="{{url('/ICO')}}">ICO</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a target="_blank" href="https://oshgroup.digital/ar">OSHGroup</a>
      </div>
    </div>
  </footer><!-- End Footer -->

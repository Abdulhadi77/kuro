            ...
            @else
                ...
                <div class="row">
                    ...
                    <div  class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div  style="height: 518px" class="member">
                            <div class="member-img">
                                <img style="height: 261px;width: 390px" src="{{ asset('storage/'.\App\Models\VotePlan::find(auth()->user()->vote_plan_id)->image)  }}" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>{{\App\Models\VotePlan::find(auth()->user()->vote_plan_id)->type}}</h4>

                                <span style="height: 128px">{!! \App\Models\VotePlan::find(auth()->user()->vote_plan_id)->description  !!}</span>
                            </div>
                            <div>

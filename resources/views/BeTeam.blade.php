        ...
        <div class="container" data-aos="fade-up">
            ...
            @else
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img style="height: 261px" src="{{ asset('storage/'.\App\Models\BFOTPlan::find(auth()->user()->b_f_o_t_plan_id)->image)  }}" class="img-fluid" alt=""></div>
                            <span class="post-date"><h4>{{\App\Models\BFOTPlan::find(auth()->user()->b_f_o_t_plan_id)->type}}</h4></span>
                            <h3 class="post-title">{!! \App\Models\BFOTPlan::find(auth()->user()->b_f_o_t_plan_id)->description  !!}</h3>
